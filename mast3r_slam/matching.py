...
def prep_for_iter_proj(X11, X21, idx_1_to_2_init):
    ...
    X21_vec = X21.view(b, -1, 3)  # (b, h*w, 3)
...
def match_iterative_proj(X11, X21, D11, D21, idx_1_to_2_init=None):
    ...
    if cfg["radius"] > 0:
        (p1, ft_matching_scores) = mast3r_slam_backends.refine_matches(
            D11.half(),
    ...
    valid_p1 = ft_matching_scores > cfg["ft_matching_threshold"]
    valid_proj2 = valid_proj2 & valid_p1
