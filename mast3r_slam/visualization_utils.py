...
def visualize_matches(
    ...
    Args:
        matches_im0: Nx2 array of coordinates in first image
        matches_im1: Nx2 array of coordinates in second image
        rgb_tensor_0, rgb_tensor_1: RGB tensors of the two images
        n_viz: Number of matches to visualize
    """
    if normalize_image:
        ...
        rgb_tensor_0 = rgb_tensor_0 * image_std + image_mean
        rgb_tensor_1 = rgb_tensor_1 * image_std + image_mean
    
    viz_imgs = [
        rgb_tensor_0.squeeze(0).permute(1, 2, 0).cpu().numpy(),
        rgb_tensor_1.squeeze(0).permute(1, 2, 0).cpu().numpy()
    ]

    
    # Sample matches to visualize
